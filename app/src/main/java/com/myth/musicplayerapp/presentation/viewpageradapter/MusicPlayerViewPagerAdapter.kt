...
class MusicPlayerViewPagerAdapter(fragmentManager : FragmentManager, lifecycle: Lifecycle, private val activity: MainActivity) :
    ...
    override fun createFragment(position: Int): Fragment {
        when(position){
            ...
            else -> return PlayerFragment(activity)
        }
